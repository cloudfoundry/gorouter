...
func (fake *FakeVarzReporter) CaptureRoutingResponseLatency(b *route.Endpoint, r *http.Response, t time.Time, d time.Duration) {
...
func (fake *FakeVarzReporter) CaptureRoutingResponseLatencyArgsForCall(i int) (*route.Endpoint, *http.Response, time.Time, time.Duration) {
	fake.captureRoutingResponseLatencyMutex.RLock()
	defer fake.captureRoutingResponseLatencyMutex.RUnlock()
