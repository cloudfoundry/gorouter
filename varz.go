...
type varz struct {
	...
	SecondsSinceLastRegistryUpdate float64 `json:"seconds_since_last_registry_update"`
}
...
func (x *RealVarz) MarshalJSON() ([]byte, error) {
	...
	x.varz.SecondsSinceLastRegistryUpdate = time.Since(x.r.timeOfLastUpdate).Seconds()
